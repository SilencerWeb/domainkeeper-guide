...
### Как изменить адрес почты?
  1. Найти все строки, в которых есть `contact@wiwka.com`.
  2. Заменить `contact@wiwka.com` на нужный вам адрес почты.
...
Inline-версия - это более оптимизированная версия, где CSS и JS вставлен прямо в код. Рекомендуется использовать именно ее.
